...
layout: post
title: Api Manual
tags: xmake docs manual
categories: xmake
permalink: /docs/xmake/manual/
---
...
We can also get it from [$(host)](https://xmake.io/zh/api/description/project-target.html#var-host) or [os.host](https://xmake.io/zh/api/description/project-target.html#os-host).
...
| ------------------------------------- | ------------------------------------- | -------- |
| [includes](https://xmake.io/zh/api/description/helper-interfaces.html#includes)                 | Add sub-project files and directories | >= 2.1.5 |
...
It will add project version info to this file automatically if we call [set_config_header](https://xmake.io/zh/api/description/project-target.html#set-config-header) to set `config.h`.`
...
| Interfaces                                    | Description                                            | Support version             |
| --------------------------------------------- | ------------------------------------------------------ | --------------------------- |
| [target](https://xmake.io/zh/api/description/project-target.html#target)                             | Define a project target                                | >= 1.0.1                    |
| [target_end](https://xmake.io/zh/api/description/project-target.html#-end)                     | End target definition                                  | >= 2.1.1                    |
| [set_kind](https://xmake.io/zh/api/description/project-target.html#set-kind)                   | Set target kind                                        | >= 1.0.1                    |
| [set_strip](https://xmake.io/zh/api/description/project-target.html#set-strip)                 | Strip target symbols                                   | >= 1.0.1                    |
| [set_default](https://xmake.io/zh/api/description/option-instance.html#set-default)             | Mark as default target                                 | >= 2.1.3                    |
| [set_options](https://xmake.io/zh/api/description/project-target.html#set-options)             | Set configuartion options                              | >= 1.0.1                    |
| [set_symbols](https://xmake.io/zh/api/description/project-target.html#set-symbols)             | Set symbol info                                        | >= 1.0.1                    |
| [set_basename](https://xmake.io/zh/api/description/project-target.html#set-basename)           | Set the base name for target file                      | >= 2.1.2                    |
| [set_warnings](https://xmake.io/zh/api/description/project-target.html#set-warnings)           | Set compilation warning level                          | >= 1.0.1                    |
| [set_optimize](https://xmake.io/zh/api/description/project-target.html#set-optimize)           | Set compilation optimization level                     | >= 1.0.1                    |
| [set_languages](https://xmake.io/zh/api/description/project-target.html#set-languages)         | Set source code language standards                     | >= 1.0.1                    |
| [set_headerdir](https://xmake.io/zh/api/description/project-target.html#set-headerdir)         | Set output directories for header files                | >= 1.0.1                    |
| [set_targetdir](https://xmake.io/zh/api/description/project-target.html#set-targetdir)         | Set output directories for target file                 | >= 1.0.1                    |
| [set_objectdir](https://xmake.io/zh/api/description/project-target.html#set-objectdir)         | Set output directories for object files                | >= 1.0.1                    |
| [add_imports](https://xmake.io/zh/api/description/project-target.html#add-imports)             | Add imported modules for the custom script             | >= 2.1.7                    |
| [add_rules](https://xmake.io/zh/api/description/project-target.html#add-rules)                 | Add custom compilation rule to target                  | >= 2.1.9                    |
| [on_load](https://xmake.io/zh/api/description/project-target.html#on-load)                     | Run custom load target configuartion script            | >= 2.1.5                    |
| [on_build](https://xmake.io/zh/api/description/project-target.html#on-build)                   | Run custom build target script                         | >= 2.0.1                    |
| [on_clean](https://xmake.io/zh/api/description/project-target.html#on-clean)                   | Run custom clean files script                          | >= 2.0.1                    |
| [on_package](https://xmake.io/zh/api/description/project-target.html#on-package)               | Run custom package target script                       | >= 2.0.1                    |
| [on_install](https://xmake.io/zh/api/description/project-target.html#on-install)               | Run custom install target file script                  | >= 2.0.1                    |
| [on_uninstall](https://xmake.io/zh/api/description/project-target.html#on-uninstall)           | Run custom uninstall target file script                | >= 2.0.1                    |
| [on_run](https://xmake.io/zh/api/description/project-target.html#on-run)                       | Run custom run target script                           | >= 2.0.1                    |
| [before_build](https://xmake.io/zh/api/description/project-target.html#before-build)           | Run custom script before building target               | >= 2.0.1                    |
| [before_clean](https://xmake.io/zh/api/description/project-target.html#before-clean)           | Run custom script before cleaning target               | >= 2.0.1                    |
| [before_package](https://xmake.io/zh/api/description/project-target.html#before-package)       | Run custom script before packaging target              | >= 2.0.1                    |
| [before_install](https://xmake.io/zh/api/description/project-target.html#before-install)       | Run custom script before installing target             | >= 2.0.1                    |
| [before_uninstall](https://xmake.io/zh/api/description/project-target.html#before-uninstall)   | Run custom script before uninstalling target           | >= 2.0.1                    |
| [before_run](https://xmake.io/zh/api/description/project-target.html#before-run)               | Run custom script before running target                | >= 2.0.1                    |
| [after_build](https://xmake.io/zh/api/description/project-target.html#after-build)             | Run custom script after building target                | >= 2.0.1                    |
| [after_clean](https://xmake.io/zh/api/description/project-target.html#after-clean)             | Run custom script after cleaning target                | >= 2.0.1                    |
| [after_package](https://xmake.io/zh/api/description/project-target.html#after-package)         | Run custom script after packaging target               | >= 2.0.1                    |
| [after_install](https://xmake.io/zh/api/description/project-target.html#after-install)         | Run custom script after installing target              | >= 2.0.1                    |
| [after_uninstall](https://xmake.io/zh/api/description/project-target.html#after-uninstall)     | Run custom script after uninstalling target            | >= 2.0.1                    |
| [after_run](https://xmake.io/zh/api/description/project-target.html#after-run)                 | Run custom script after running target                 | >= 2.0.1                    |
| [set_config_h](https://xmake.io/zh/api/description/project-target.html#set-config-h)           | Set auto-generated config header file                  | >= 1.0.1 < 2.1.5 deprecated |
| [set_config_h_prefix](https://xmake.io/zh/api/description/project-target.html#set-config-h)    | Set macro prefix in auto-generated config header       | >= 1.0.1 < 2.1.5 deprecated |
| [set_config_header](https://xmake.io/zh/api/description/project-target.html#set-config-header) | Set auto-generated config header file (new)            | >= 2.1.5                    |
| [set_pcheader](https://xmake.io/zh/api/description/project-target.html#set-pcheader)           | Set pre-compiled c header file                         | >= 2.1.5                    |
| [set_pcxxheader](https://xmake.io/zh/api/description/project-target.html#set-pcxxheader)       | Set pre-compiled c++ header file                       | >= 2.1.5                    |
| [add_deps](https://xmake.io/zh/api/description/project-target.html#add-deps)                   | Add target dependencies                                | >= 1.0.1                    |
| [add_links](https://xmake.io/zh/api/description/project-target.html#add-links)                 | Add link libraries                                     | >= 1.0.1                    |
| [add_files](https://xmake.io/zh/api/description/project-target.html#add-files)                 | Add source files                                       | >= 1.0.1                    |
| [del_files](https://xmake.io/zh/api/description/project-target.html#del-files)                 | Remove source files                                    | >= 2.1.9                    |
| [add_headers](https://xmake.io/zh/api/description/project-target.html#add-headers)             | Add installed header files                             | >= 1.0.1                    |
| [add_linkdirs](https://xmake.io/zh/api/description/project-target.html#add-linkdirs)           | Add link search directories                            | >= 1.0.1                    |
| [add_rpathdirs](https://xmake.io/zh/api/description/project-target.html#add-rpathdirs)         | Add load search directories for dynamic library        | >= 2.1.3                    |
| [add_includedirs](https://xmake.io/zh/api/description/project-target.html#add-includedirs)     | Add include search directories                         | >= 1.0.1                    |
| [add_defines](https://xmake.io/zh/api/description/option-instance.html#add-defines)             | Add macro definition                                   | >= 1.0.1                    |
| [add_undefines](https://xmake.io/zh/api/description/project-target.html#add-undefines)         | Add macro undefinition                                 | >= 1.0.1                    |
| [add_defines_h](https://xmake.io/zh/api/description/project-target.html#add-defines-h)         | Add macro definition to auto-generated config header   | >= 1.0.1                    |
| [add_undefines_h](https://xmake.io/zh/api/description/project-target.html#add-undefines-h)     | Add macro undefinition to auto-generated config header | >= 1.0.1                    |
| [add_cflags](https://xmake.io/zh/api/description/project-target.html#add-cflags)               | Add c compilation flags                                | >= 1.0.1                    |
| [add_cxflags](https://xmake.io/zh/api/description/project-target.html#add-cxflags)             | Add c/c++ compilation flags                            | >= 1.0.1                    |
| [add_cxxflags](https://xmake.io/zh/api/description/project-target.html#add-cxxflags)           | Add c++ compilation flags                              | >= 1.0.1                    |
| [add_mflags](https://xmake.io/zh/api/description/project-target.html#add-mflags)               | Add objc compilation flags                             | >= 1.0.1                    |
| [add_mxflags](https://xmake.io/zh/api/description/project-target.html#add-mxflags)             | Add objc/objc++ compilation flags                      | >= 1.0.1                    |
| [add_mxxflags](https://xmake.io/zh/api/description/project-target.html#add-mxxflags)           | Add objc++ compilation flags                           | >= 1.0.1                    |
| [add_scflags](https://xmake.io/zh/api/description/project-target.html#add-scflags)             | Add swift compilation flags                            | >= 2.0.1                    |
| [add_asflags](https://xmake.io/zh/api/description/project-target.html#add-asflags)             | Add asm compilation flags                              | >= 2.0.1                    |
| [add_gcflags](https://xmake.io/zh/api/description/project-target.html#add-gcflags)             | Add go compilation flags                               | >= 2.1.1                    |
| [add_dcflags](https://xmake.io/zh/api/description/project-target.html#add-dcflags)             | Add dlang compilation flags                            | >= 2.1.1                    |
| [add_rcflags](https://xmake.io/zh/api/description/project-target.html#add-rcflags)             | Add rust compilation flags                             | >= 2.1.1                    |
| [add_ldflags](https://xmake.io/zh/api/description/project-target.html#add-ldflags)             | Add static library link flags                          | >= 1.0.1                    |
| [add_arflags](https://xmake.io/zh/api/description/project-target.html#add-arflags)             | Add archive library flags                              | >= 1.0.1                    |
| [add_shflags](https://xmake.io/zh/api/description/project-target.html#add-shflags)             | Add dynamic library link flags                         | >= 1.0.1                    |
| [add_cfunc](https://xmake.io/zh/api/description/project-target.html#add-cfunc)                 | Add single c function for checking                     | >= 2.0.1                    |
| [add_cxxfunc](https://xmake.io/zh/api/description/project-target.html#add-cxxfunc)             | Add single c++ function for checking                   | >= 2.0.1                    |
| [add_cfuncs](https://xmake.io/zh/api/description/project-target.html#add-cfuncs)               | Add c functions for checking                           | >= 2.0.1                    |
| [add_cxxfuncs](https://xmake.io/zh/api/description/project-target.html#add-cxxfuncs)           | Add c++ functions for checking                         | >= 2.0.1                    |
| [add_packages](https://xmake.io/zh/api/description/project-target.html#add-packages)           | Add package dependencies                               | >= 2.0.1                    |
| [add_options](https://xmake.io/zh/api/description/project-target.html#add-options)             | Add options dependencies                               | >= 2.0.1                    |
| [add_languages](https://xmake.io/zh/api/description/project-target.html#add-languages)         | Add language standards                                 | >= 1.0.1                    |
| [add_vectorexts](https://xmake.io/zh/api/description/project-target.html#add-vectorexts)       | Add vector extensions                                  | >= 1.0.1                    |
| [add_frameworks](https://xmake.io/zh/api/description/project-target.html#add-frameworks)       | Add frameworks                                         | >= 2.1.1                    |
| [add_frameworkdirs](https://xmake.io/zh/api/description/project-target.html#add-frameworkdirs) | Add framework search directories                       | >= 2.1.5                    |
