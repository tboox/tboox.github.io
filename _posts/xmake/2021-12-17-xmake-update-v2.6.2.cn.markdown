...
更多，交叉编译配置文档，见：[配置交叉编译](https://xmake.io/zh/guide/configuration?id=common-cross-compilation-configuration)
...
也非常感谢大家对 Xmake 的赞助的支持，使得我能够有足够的动力去持续维护，完整捐助列表见：[Sponsors](https://xmake.io/zh/about/sponsor)。
