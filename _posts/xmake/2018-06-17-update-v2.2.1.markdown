...
To make [xmake](https://github.com/tboox/xmake) more convenient and flexible to support other compilation environments, I spent four months to upgrade [custom rule rules](https://xmake.io/#/manual?id=custom-rule).
...
* [Github Repo](https://github.com/tboox/xmake)
