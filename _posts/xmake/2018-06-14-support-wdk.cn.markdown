...
关于`add_values`的使用说明，可以看下文档：[add_values和set_values的使用说明](https://xmake.io/zh/api/description/project-target.html#targetset_values)，简单来说，就是用来给对应规则传递扩展参数设置的。
...
关于更多xmake下WDK开发相关介绍，请参考文档：[WDK驱动程序开发](https://xmake.io/zh/examples/cpp/wdk.html)
