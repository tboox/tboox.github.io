...
xmake 一直有提供 config.h 的自动生成特性，可以通过 [add_configfiles](https://xmake.io/zh/api/description/project-target.html#targetadd_configfiles) 接口来配置，并且它还支持模板变量的替换，用户可以自己定义一些变量。

不过，xmake 也提供了一些常用的内置变量替换，比如 版本信息，平台架构等。具体详情见：[https://xmake.io/zh/api/description/project-target.html#targetadd_configfiles](https://xmake.io/zh/api/description/project-target.html#targetadd_configfiles)
