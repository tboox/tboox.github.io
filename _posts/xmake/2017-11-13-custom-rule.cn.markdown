...
具体使用介绍，可参考相关文档：[rule规则使用手册](https://xmake.io/#/zh/manual?id=%E6%9E%84%E5%BB%BA%E8%A7%84%E5%88%99)
...
其中`add_imports`用于预先导入扩展模块，可在多个自定义脚本中直接使用，具体说明见：[add_imports文档](https://xmake.io/#/zh/manual?id=targetadd_imports)
