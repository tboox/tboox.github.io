...
如果你看了[工程描述入门](/cn/xmake/2016/02/03/xmake-project-description.html)，那么是否觉得通过 add_files 添加源文件相当的方便？
...
这个的详细介绍，可参看[高级特性之合并静态库](/cn/xmake/2016/02/04/xmake-merge-static-library.html)
