\hypertarget{epoll_8c}{\section{src/platform/unix/asio/reactor/aiop/epoll.c File Reference}
\label{epoll_8c}\index{src/platform/unix/asio/reactor/aiop/epoll.\-c@{src/platform/unix/asio/reactor/aiop/epoll.\-c}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=344pt]{d1/d3f/epoll_8c__incl}
\end{center}
\end{figure}
...
Definition in file \hyperlink{epoll_8c_source}{epoll.\-c}.
